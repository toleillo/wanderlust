export const es = {
  ...
  newsletter_success_sub: "Te avisaremos cuando publiquemos nuevas guías y destinos.",
...
export const en = {
  ...
  newsletter_success_sub: "We'll let you know when we publish new guides and destinations.",
