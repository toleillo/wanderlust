export const GUIDES = [
...

  {
    ...
    tableItems: [
      {
        partner: "revolut",
        query: "revolut travel card standard",
        features: "Tipo cambio real, Tarjetas virtuales, IBAN español, Apple/Google Pay",
        bestFor: { es: "Pagos y App completa", en: "Payments & Feature-rich App" },
        highlight: true,
      },
      {
        partner: "wise",
        query: "wise multi-currency account",
        features: "Multidivisa real, Transferencias baratas, Retiradas 200€/mes, Web robusta",
        bestFor: { es: "Transferencias y Multidivisa", en: "Transfers & Multi-currency" },
        highlight: false,
      }
    ],
    items: [
  ...
  },
  {
    ...
    subtitle: {
      ...
      en: "Stop paying roaming fees. We analyze coverage, speed and real price of the top 3 eSIMs on the market after testing them in 12 countries.",
    },
    category: { es: "Comparativas", en: "Comparisons" },
    ...
    tableItems: [
      {
        partner: "airalo",
        query: "airalo esim travel",
        features: "Cobertura global 200+ países, App muy intuitiva, Precios desde $4.50, Recarga fácil",
        bestFor: { es: "Viajes cortos y precio bajo", en: "Short trips & low price" },
        highlight: true,
      },
      {
        partner: "holafly",
        query: "holafly unlimited data",
        features: "Datos Ilimitados reales, Soporte 24/7 en español, Cobertura multi-red, Sin recargas",
        bestFor: { es: "Datos Ilimitados y Tranquilidad", en: "Unlimited Data & Peace of Mind" },
        highlight: false,
      },
      {
        partner: "saily",
        query: "saily nordvpn esim",
        features: "Seguridad NordVPN, Planes regionales Europa/Asia, Instalación en 1 clic, Precios medios",
        bestFor: { es: "Seguridad y Privacidad", en: "Security & Privacy" },
        highlight: false,
      }
    ],
    items: [],
    ...
    ctaPartners: ["airalo", "holafly", "saily"],
  },
];
