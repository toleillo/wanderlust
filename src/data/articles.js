    ...
    pointsOfInterest: [
      {
        ...
        category: "museum",
        rating: 4.8,
        description: { es: "El centro del poder de la República Serenísima durante casi mil años. El Palacio Ducal es la sede del Dogo, el Senado, los tribunales y las prisiones — todo en el mismo edificio. El Puente de los Suspiros conecta los salones del poder con las celdas: la distancia entre la condena y el encierro era literalmente de veinte metros. Reserva con antelación o la cola puede ser de dos horas.", en: "The seat of power of the Serenissima Republic for nearly a thousand years. The Doge's Palace housed the Doge, the Senate, the courts and the prisons — all in the same building. The Bridge of Sighs connects the halls of power to the cells: the distance between sentencing and imprisonment was literally twenty metres. Book ahead or the queue can be two hours." },
        affiliateLinks: [{ label: { es: "Entradas Palacio Ducal sin colas", en: "Doge's Palace skip-the-line tickets" }, partner: "tiqets", query: "doge's palace venice skip line", type: "tickets" }, { label: { es: "Tour Palacio Ducal + San Marcos", en: "Doge's Palace + St Mark's tour" }, partner: "musement", query: "doge's palace venice guided tour", type: "activity" }],
      },
      {
      ...
      },
      {
        ...
        category: "food",
        rating: 4.9,
        description: { es: "Los bacari son los bares de vino locales donde Venecia come de verdad. Un cicchetto — la tapa veneciana — cuesta entre 1 y 2,50 euros: baccalà mantecato sobre pan tostado, sardinas en saor, nervetti con cebollas. La calle Sottoportego dei Preti y la zona de Cannaregio concentran los mejores. Un ombra de vino blanco (la medida veneciana, unos 75ml) vale 1,50 euros. Evita la zona de Rialto y San Marcos: los mismos cicchetti cuestan el triple.", en: "Bacari are the local wine bars where Venice actually eats. A cicchetto — the Venetian tapa — costs between 1 and 2.50 euros: baccalà mantecato on toast, sardines in saor, nervetti with onions. Sottoportego dei Preti and the Cannaregio area concentrate the best ones. An ombra of white wine (the Venetian measure, about 75ml) costs 1.50 euros. Avoid the Rialto and San Marco area: the same cicchetti cost three times as much." },
        affiliateLinks: [{ label: { es: "Food tour cicchetti y vinos", en: "Cicchetti and wine food tour" }, partner: "getyourguide", query: "venice cicchetti food tour", type: "activity" }, { label: { es: "Tour gastronómico Venecia", en: "Venice gastronomic tour" }, partner: "musement", query: "venice food tour cannaregio", type: "activity" }],
      },
      {
...
Murano merece la visita aunque ya hayas visto suficiente vidrio en tu vida. Lo que no esperas es que las demostraciones en los hornos artesanales sean gratuitas: entras por las puertas de las fábricas que no tienen cartel turístico y un maestro vidriero hace delante de ti un caballo o un jarrón en cuatro minutos con el mismo gesto tranquilo con el que alguien firmaría un documento. {{CTA:activity:getyourguide:murano glass tour venice:Tour a Murano con demostración de vidrio}}

Una nota logística: el agua de Venecia es potable y gratuita en las fuentes públicas (hay más de 100 en la ciudad). El transporte en vaporetto con pase de 48 o 72 horas sale más rentable que pagar por trayecto si haces más de cuatro viajes al día. {{CTA:tickets:tiqets:venice vaporetto pass transport:Pase de vaporetto 48/72 horas}} El aeropuerto Marco Polo queda a 40 minutos en barco lanzadera (alilaguna) o 20 minutos en autobús hasta Piazzale Roma. Y si vienes en tren desde Florencia o Roma, llegas directamente a Santa Lucía — dentro de la ciudad, no en las afueras.

Para alojamiento: el lado del Cannaregio cerca de la estación tiene los precios más razonables y el acceso más fácil. {{CTA:hotel:booking:venecia hotel cannaregio:Busca hotel en Venecia}} Los hoteles de San Marcos cobran el triple por el mismo nivel. Y sí, me quedé en el Cannaregio. Podría decir que fue una decisión estratégica. En realidad fue porque el bacaro del barrio abría a las 10 de la mañana.`,
      en: `Venice shouldn't exist. 118 islands connected by 400 bridges over a muddy Adriatic lagoon, built over centuries on wooden piles driven into the silt. Logic says it should have sunk 700 years ago. But Venice has been an independent republic since the 7th century and a museum-city ever since tourists discovered they could come here to photograph decay in real time.

David arrived with a restaurant list and left with the theory that Venice is the only city in the world where the architecture is less impressive than the food. This is debatable. What isn't debatable is that the cicchetti of Cannaregio are one of the most convincing arguments for buying a train ticket. {{CTA:activity:getyourguide:venice cicchetti food tour:Book a food tour through the bacari}}

The cicchetti trick is this: the further you get from San Marco and the Rialto, the cheaper and better they are. The rule works without exceptions. Baccalà mantecato — salt cod worked with olive oil into a dense, slightly spiced mousse — costs between 1.80 and 2.50 euros on a slice of toasted polenta in Cannaregio. On Corte Contarina near San Marco, the same dish costs 5.50 euros and tastes identical. {{CTA:tickets:tiqets:doge's palace venice skip line:Skip-the-line Doge's Palace tickets}}

The Doge's Palace was the place that took me longest to understand on a first visit. It's not just a palace: it's the complete government system of the Serenissima Republic compressed into a single building. The Council of Ten, the Inquisition, the prisons, the negotiation chambers, the archives, the courts — all connected by secret staircases and unnamed corridors. The Bridge of Sighs has the romantic reputation tourists have given it, but it's basically the corridor between sentencing and the cell. The history of the Venetian Republic is as fascinating as its architecture and no audio guide does justice to either. {{CTA:activity:musement:doge's palace venice guided tour:Guided tour with expert guide}}
...
Murano is worth the trip even if you've already seen enough glass in your life. What you don't expect is that the demonstrations in artisan furnaces are free: you walk through the doors of factories without tourist signs and a master glassblower makes a horse or a vase in front of you in four minutes, with the same unhurried gesture as someone signing a document. {{CTA:activity:getyourguide:murano glass tour venice:Tour to Murano with glassblowing demonstration}}

A logistical note: Venice's water is drinkable and free from public fountains (there are over 100 in the city). A 48 or 72-hour vaporetto pass works out cheaper than paying per journey if you make more than four trips a day. {{CTA:tickets:tiqets:venice vaporetto pass transport:48/72-hour vaporetto pass}} Marco Polo airport is 40 minutes by water taxi (Alilaguna) or 20 minutes by bus to Piazzale Roma. And if you arrive by train from Florence or Rome, you pull directly into Santa Lucia — inside the city, not on the outskirts.

For accommodation: the Cannaregio side near the station has the most reasonable prices and easiest access. {{CTA:hotel:booking:venecia hotel cannaregio:Find a hotel in Venice}} Hotels in San Marco charge triple for the same standard. And yes, I stayed in Cannaregio. I could claim it was a strategic decision. In reality it was because the neighbourhood bacaro opened at 10am.`,
    },
    faq: {
      es: [
        { question: "¿Cuánto cuesta el transporte en vaporetto en Venecia?", answer: "Un billete sencillo cuesta 9,50 euros. Si haces más de cuatro trayectos al día, el pase de 24 horas (25€), 48 horas (35€) o 72 horas (45€) sale más rentable. El pase incluye todos los vaporetti de ACTV en la ciudad y hasta Murano, Burano y el Lido." },
        { question: "¿Qué es un bacaro y qué son los cicchetti?", answer: "Un bacaro es el bar de vino tradicional veneciano. Los cicchetti son las tapas venecianas: pequeñas porciones de baccalà mantecato, sardinas en saor, boquerones, nervetti o polpette (albóndigas) servidas sobre pan o polenta tostada, a entre 1 y 2,50 euros la pieza. Se acompañan de un ombra — un vasito de vino blanco de la región del Véneto." },
        { question: "¿Es necesario reservar el Palacio Ducal con antelación?", answer: "Sí, especialmente en temporada alta (abril-octubre) y durante el Carnaval. Sin reserva, la cola puede superar las dos horas. La entrada con reserva online es más cara que en taquilla pero te garantiza el horario. El museo abre de 9:00 a 19:00 (última entrada a las 18:00)." },
        { question: "¿Vale la pena ir a Murano?", answer: "Sí si evitas los showrooms turísticos y entras directamente en los talleres artesanales, donde las demostraciones son gratuitas. La isla está a 10-15 minutos en vaporetto desde Fondamenta Nove (línea 4.1 o 4.2). Murano también tiene un canal principal tranquilo y buenos restaurantes locales sin la presión de precio de la ciudad principal." },
        { question: "¿Cuál es la mejor zona para alojarse en Venecia sin arruinarse?", answer: "Cannaregio (cerca de la estación de Santa Lucía) es el barrio más accesible en precio y tiene algunos de los mejores bacari de la ciudad. Castello (al este, lejos de San Marcos) es también una buena opción. San Polo tiene precios intermedios con fácil acceso al Rialto. Evita los hoteles directamente en San Marcos si el presupuesto es un factor." },
      ],
      en: [
        { question: "How much does vaporetto transport cost in Venice?", answer: "A single ticket costs 9.50 euros. If you make more than four journeys a day, the 24-hour (€25), 48-hour (€35) or 72-hour (€45) pass is better value. The pass includes all ACTV vaporetti in the city and to Murano, Burano and the Lido." },
        { question: "What is a bacaro and what are cicchetti?", answer: "A bacaro is the traditional Venetian wine bar. Cicchetti are Venetian tapas: small portions of baccalà mantecato, sardines in saor, anchovies, nervetti or polpette (meatballs) served on bread or toasted polenta, at between 1 and 2.50 euros each. They come with an ombra — a small glass of white wine from the Veneto region." },
        { question: "Do I need to book the Doge's Palace in advance?", answer: "Yes, especially in high season (April–October) and during Carnival. Without a booking, the queue can exceed two hours. Online booking is slightly pricier than at the ticket office but guarantees your time slot. The museum opens 9:00–19:00 (last entry 18:00)." },
        { question: "Is it worth going to Murano?", answer: "Yes, if you avoid tourist showrooms and head straight to artisan workshops, where demonstrations are free. The island is 10–15 minutes by vaporetto from Fondamenta Nove (lines 4.1 or 4.2). Murano also has a quiet main canal and good local restaurants without the pricing pressure of the main city." },
        { question: "What's the best area to stay in Venice without breaking the bank?", answer: "Cannaregio (near Santa Lucia station) is the most affordable neighbourhood and has some of the city's best bacari. Castello (east, away from San Marco) is also a good option. San Polo has mid-range prices with easy Rialto access. Avoid hotels directly on San Marco if budget is a factor." },
      ],
    },
  },
  {
...
Tivoli at night with 100,000 lights on is the Copenhagen experience most underrated by visitors who come in search of museums and architecture. {{CTA:tickets:tiqets:tivoli gardens copenhagen tickets:Tivoli Gardens tickets}} It's a 19th-century amusement park that hasn't tried to be modern and is irresistible because of it. {{CTA:hotel:booking:copenhague hotel vesterbro norrebro centro:Find a hotel in Copenhagen}}`,
  ...
  },
  {
    ...
    content: {
      es: `Llegué a Hanói con el plan de quedarme diez días y me quedé seis semanas. Eso no estaba en la hoja de cálculo.
...
Las 36 calles gremiales medievales siguen funcionando con la misma lógica de hace siglos aunque los gremios hayan evolucionado. Calle de la Seda vende seda. Calle del Papel vende papel y artículos de papelería. La manera de explorarlo sin volverse loco es elegir dos o tres calles por la mañana, desayunar en la primera banchería que huela bien y seguir el ruido. {{CTA:activity:getyourguide:hanoi old quarter street food tour:Tour de comida callejera por el barrio}}

**Halong Bay: la excursión obligatoria**

A 3,5 horas de Hanói, Halong Bay es uno de los paisajes más sobrecogedores de Asia: 1.969 islotes kársticos emergiendo del agua esmeralda. Los tours de un día desde Hanói funcionan bien y son la opción más eficiente si no tienes tiempo para una noche en barco. Madruga porque las primeras horas con la niebla sobre el agua son incomparables. {{CTA:activity:civitatis:halong bay day trip from hanoi:Excursión a Halong Bay desde Hanói}}
...
Vietnam tiene una infraestructura de datos móviles sorprendentemente buena. La eSIM de Airalo para Vietnam —plan de 3GB por unos 5€— funciona desde el aterrizaje sin tocar ninguna tarjeta física. Imprescindible para el trayecto del aeropuerto al hotel. {{CTA:service:airalo:airalo vietnam esim:eSIM Vietnam con Airalo}}

Para el seguro de viaje, SafetyWing cubre Vietnam y el resto del Sudeste Asiático en su plan nómada por 45,08$/mes. Compensa frente a seguros de viaje tradicionales si piensas moverte por la región. {{CTA:service:safetywing:safetywing nomad insurance:Seguro nómada SafetyWing}}
...
El coste de vida en Hanói para nómada con criterio: apartamento en Tay Ho 500-700€/mes, comida callejera diaria 5-8€, co-working 8-12€/día o 120-180€/mes. Total real: 900-1.100€ al mes viviendo bien. Para eso, este nivel de ciudad no lo encuentras en Europa ni en precio cercano.`,
      en: `I arrived in Hanoi planning to stay ten days and stayed six weeks. That wasn't in the spreadsheet.
...
Vietnam has a surprisingly good mobile data infrastructure. The Airalo eSIM for Vietnam — a 3GB plan for around €5 — works from landing without touching any physical SIM card. Essential for the airport-to-hotel journey. {{CTA:service:airalo:airalo vietnam esim:Vietnam eSIM with Airalo}}

For travel insurance, SafetyWing covers Vietnam and the rest of Southeast Asia on its nomad plan for $45.08/month. Worth it compared to traditional travel insurance if you plan to move around the region. {{CTA:service:safetywing:safetywing nomad insurance:SafetyWing nomad insurance}}
...
Cost of living in Hanoi for a nomad with standards: apartment in Tay Ho €500-700/month, daily street food €5-8, co-working €8-12/day or €120-180/month. Real total: €900-1,100 a month living well. For that, you won't find this level of city in Europe at anywhere near that price.`
    ...
    faq: {
      es: [
        { question: "¿Es Hanói segura para viajeros en solitario?", answer: "Sí, Hanói es una de las ciudades más seguras del Sudeste Asiático para viajeros en solitario, incluidas mujeres. Los delitos violentos son extremadamente raros. Los principales riesgos son estafas de taxi en el aeropuerto (usa Grab siempre) y timos menores en zonas muy turísticas del barrio antiguo. El tráfico de motocicletas es el peligro más real — cruza siempre a paso constante y sin correr." },
        { question: "¿Cuántos días necesito para ver Hanói?", answer: "Tres días son suficientes para lo esencial: barrio antiguo, lago Hoan Kiem, Museo de Etnología, Hoa Lo Prison y una tarde en Tay Ho. Con cinco días puedes añadir Halong Bay de un día o dos y explorar la ciudad con más calma. Para quedarte trabajando en remoto, lo mínimo es dos semanas — la ciudad mejora con el tiempo." },
        { question: "¿Cuál es la mejor época para visitar Hanói?", answer: "Octubre y noviembre son los mejores meses: temperatura agradable (22-28°C), poca lluvia y humedad manejable. Marzo y abril también son buenos. Evita julio y agosto (monzón fuerte, humedad extrema) y enero (frío húmedo que no esperarías en el trópico, con temperaturas de 10-15°C en noches malas)." },
        { question: "¿Cómo llegar del aeropuerto al centro de Hanói?", answer: "El aeropuerto internacional Noi Bai está a 35km del centro. Opciones: Grab (equivalente a Uber, 8-12€, la opción más recomendable), taxi oficial desde los mostradores del aeropuerto (negocia precio fijo antes de subir, unos 15€), o autobús 86 directo al barrio antiguo por 1€ pero tarda 60-90 minutos." },
        { question: "¿Qué eSIM funciona mejor en Vietnam?", answer: "Airalo y Saily funcionan muy bien en Vietnam con cobertura 4G/LTE en todo el país. Los planes de 3GB de Airalo (unos 5€) son suficientes para una semana de uso normal. Si vas a quedarte más tiempo o a trabajar en remoto, el plan de 10GB de Airalo es la mejor relación calidad-precio. La cobertura es excelente en ciudades; en zonas rurales del norte puede flojear." }
      ],
      en: [
        { question: "Is Hanoi safe for solo travellers?", answer: "Yes, Hanoi is one of the safest cities in Southeast Asia for solo travellers, including women. Violent crime is extremely rare. The main risks are airport taxi scams (always use Grab) and minor tourist touts in busy parts of the old quarter. Motorbike traffic is the most real danger — always cross at a steady pace without running." },
        { question: "How many days do I need to see Hanoi?", answer: "Three days are enough for the essentials: old quarter, Hoan Kiem Lake, Museum of Ethnology, Hoa Lo Prison and an afternoon in Tay Ho. With five days you can add a Halong Bay day trip or two and explore the city at a more relaxed pace. For remote working, the minimum is two weeks — the city improves with time." },
        { question: "What is the best time to visit Hanoi?", answer: "October and November are the best months: pleasant temperature (22-28°C), little rain and manageable humidity. March and April are also good. Avoid July and August (heavy monsoon, extreme humidity) and January (damp cold you wouldn't expect in the tropics, with temperatures of 10-15°C on bad nights)." },
        { question: "How do I get from the airport to central Hanoi?", answer: "Noi Bai International Airport is 35km from the centre. Options: Grab (Uber equivalent, €8-12, the most recommended option), official taxi from airport desks (negotiate a fixed price before getting in, around €15), or bus 86 direct to the old quarter for €1 but it takes 60-90 minutes." },
        { question: "Which eSIM works best in Vietnam?", answer: "Airalo and Saily both work very well in Vietnam with 4G/LTE coverage across the country. Airalo's 3GB plans (around €5) are enough for a week of normal use. If you're staying longer or working remotely, Airalo's 10GB plan is the best value. Coverage is excellent in cities; in rural areas of the north it can be patchy." }
      ]
    }
  },
  {
    ...
    pointsOfInterest: [
      {
        name: { es: "Murallas de Dubrovnik", en: "Dubrovnik City Walls" },
        description: { es: "2km de murallas medievales sobre el Adriático. Las mejores vistas de la ciudad y del mar. Imprescindible madrugar: antes de las 9am el recorrido se hace sin multitudes y la luz del Adriático sobre los tejados de teja naranja es de las mejores cosas que verás en un viaje europeo. En julio a las 11am son un convoy de turistas sudorosos a 40°C. Hay taquillas en tres puntos de acceso — la entrada junto a la Puerta Pile es la más concurrida; prueba la entrada del Fuerte Revelin para evitar colas.", en: "2km of medieval walls over the Adriatic. The best views of the city and the sea. Essential to get there early: before 9am the walk is done without crowds and the Adriatic light on the orange-tiled rooftops is one of the best things you'll see on a European trip. In July at 11am it's a convoy of sweaty tourists at 40°C. There are ticket booths at three access points — the entrance by Pile Gate is the most crowded; try the Revelin Fort entrance to avoid queues." },
        affiliateLinks: [
          { partner: "tiqets", label: { es: "Entrada a las murallas de Dubrovnik", en: "Dubrovnik city walls entry ticket" }, query: "dubrovnik city walls ticket" },
          { partner: "getyourguide", label: { es: "Tour guiado por las murallas", en: "Guided walls tour" }, query: "dubrovnik walls guided tour" }
        ]
      },
      {
        name: { es: "Ciudad Vieja (Stari Grad)", en: "Old Town (Stari Grad)" },
        description: { es: "Declarada Patrimonio de la Humanidad por la UNESCO. El Stradun —la calle principal de piedra pulida— fue reconstruido tras el terremoto de 1667 y los daños del sitio de 1991-1992 con una precisión casi obsesiva. Flanqueándolo: la Fuente Grande de Onofrio (1438), la iglesia de San Blas patrón de la ciudad, el Palacio del Rector, la Catedral. Todo en menos de 700m. Es una ciudad medieval que funciona: la gente vive aquí, hay una farmacia que lleva abierta sin interrupción desde 1317 (se dice que es la más antigua de Europa en funcionamiento) y las terrazas se llenan de lugareños por la noche.", en: "Declared a UNESCO World Heritage Site. The Stradun — the main street of polished stone — was rebuilt after the 1667 earthquake and the damage from the 1991-1992 siege with an almost obsessive precision. Flanking it: the Large Onofrio Fountain (1438), the church of St Blaise patron of the city, the Rector's Palace, the Cathedral. All within less than 700m. It's a medieval city that works: people actually live here, there's a pharmacy that has been open continuously since 1317 (said to be the oldest working pharmacy in Europe) and the terraces fill up with locals at night." },
        affiliateLinks: [
          { partner: "getyourguide", label: { es: "Tour a pie por la ciudad vieja", en: "Old town walking tour" }, query: "dubrovnik old town walking tour" },
          { partner: "viator", label: { es: "Tour histórico de Dubrovnik", en: "Dubrovnik historic tour" }, query: "dubrovnik historic walking tour" }
        ]
      },
      {
        name: { es: "Fuerte Lovrijenac y escenarios de Juego de Tronos", en: "Lovrijenac Fortress and Game of Thrones locations" },
        description: { es: "El Fuerte Lovrijenac —pegado a las murallas occidentales, sobre un acantilado de 37 metros sobre el mar— es Desembarco del Rey en la vida real. Si nunca has visto Juego de Tronos, sigue siendo uno de los fuertes medievales más impresionantes de Europa. Si lo has visto, la experiencia de reconocer las localizaciones es genuinamente placentera aunque lo niegues. Los tours temáticos duran 2 horas, tienen guías que conocen el show mejor que los showrunners y cuestan alrededor de 30-35€.", en: "Lovrijenac Fortress — pressed against the western walls, on a 37-metre cliff above the sea — is King's Landing in real life. If you've never seen Game of Thrones, it's still one of the most impressive medieval fortresses in Europe. If you have, the experience of recognising the locations is genuinely pleasurable even if you deny it. Themed tours last 2 hours, have guides who know the show better than the showrunners and cost around €30-35." },
        affiliateLinks: [
          { partner: "viator", label: { es: "Tour de Juego de Tronos en Dubrovnik", en: "Game of Thrones tour Dubrovnik" }, query: "dubrovnik game of thrones tour" },
          { partner: "getyourguide", label: { es: "Tour de GoT y murallas combinado", en: "GoT and walls combined tour" }, query: "dubrovnik game of thrones walls tour" }
        ]
      },
      {
        name: { es: "Isla Lokrum", en: "Lokrum Island" },
        description: { es: "15 minutos en barca desde el puerto antiguo. La isla tiene pavos reales sueltos que no le tienen miedo a nadie, playas de piedra con aguas cristalinas, un convento benedictino en ruinas del siglo XI y un pequeño lago salado interior (el Mar Muerto de Lokrum). La barca sale cada hora y la entrada incluye el barco de vuelta. Lleva algo de comida — hay un restaurante pero los precios son astronómicos. La leyenda dice que Ricardo Corazón de León naufragó aquí en 1192 y construyó una iglesia en agradecimiento.", en: "15 minutes by boat from the old port. The island has free-roaming peacocks with no fear of humans, rocky beaches with crystal-clear water, a ruined 11th-century Benedictine monastery and a small inland saltwater lake (the Lokrum Dead Sea). The boat runs every hour and entry includes the return boat. Bring some food — there's a restaurant but the prices are astronomical. Legend has it that Richard the Lionheart was shipwrecked here in 1192 and built a church in gratitude." },
        affiliateLinks: [
          { partner: "tiqets", label: { es: "Barca y entrada a Lokrum", en: "Lokrum island boat and entry" }, query: "lokrum island dubrovnik" }
        ]
      },
      {
        name: { es: "Monte Srđ y el teleférico", en: "Mount Srđ and the cable car" },
        description: { es: "Vistas panorámicas de la ciudad y el Adriático desde 412 metros. El teleférico sube en 4 minutos. Desde arriba se ve la ciudad amurallada completa, las islas Elafiti y, en días claros, las costas de Bosnia y Montenegro. Hay un restaurante en la cima y un museo sobre el Sitio de Dubrovnik de 1991-1995 que merece más atención de la que recibe. El teleférico fue destruido durante el sitio y reconstruido en 2010.", en: "Panoramic views of the city and the Adriatic from 412 metres. The cable car takes 4 minutes. From the top you see the complete walled city, the Elafiti islands and, on clear days, the coasts of Bosnia and Montenegro. There's a restaurant at the summit and a museum about the 1991-1995 Siege of Dubrovnik that deserves more attention than it gets. The cable car was destroyed during the siege and rebuilt in 2010." },
        affiliateLinks: [
          { partner: "tiqets", label: { es: "Ticket teleférico Monte Srđ", en: "Mount Srđ cable car ticket" }, query: "dubrovnik cable car mount srd" },
          { partner: "getyourguide", label: { es: "Tour panorámico de Dubrovnik", en: "Dubrovnik panoramic tour" }, query: "dubrovnik panoramic tour" }
        ]
      }
    ],
    events: [
      {
        name: { es: "Festival de Verano de Dubrovnik", en: "Dubrovnik Summer Festival" },
        date: { es: "Julio–Agosto", en: "July–August" },
        type: "festival",
        description: { es: "Teatro, ópera, música clásica y danza en localizaciones históricas de la ciudad vieja: el Fuerte Lovrijenac, el Claustro del Convento Franciscano, el Atrio del Palacio del Rector. El festival más antiguo de Croacia (fundado en 1950). Entradas desde 15€ para conciertos menores hasta 80-100€ para ópera en el Fuerte. Coexiste con la invasión turística de julio, así que las entradas hay que comprarlas con meses de antelación.", en: "Theatre, opera, classical music and dance at historic locations in the old town: Lovrijenac Fortress, the Franciscan Monastery Cloister, the Rector's Palace Atrium. The oldest festival in Croatia (founded in 1950). Tickets from €15 for minor concerts to €80-100 for opera at the Fortress. It coexists with the July tourist invasion, so tickets need to be bought months in advance." }
      },
      {
        name: { es: "Good Food Festival", en: "Good Food Festival" },
        date: { es: "Octubre", en: "October" },
        type: "gastronomy",
        description: { es: "Festival gastronómico con chefs locales e internacionales, catas de vino dálmata y productos de la región. Octubre es además uno de los mejores meses para visitar Dubrovnik: menos turistas, precios más bajos y temperatura agradable (20-24°C). El festival tiene cenas de gala, mercados de productores y clases de cocina.", en: "Gastronomy festival with local and international chefs, Dalmatian wine tastings and regional produce. October is also one of the best months to visit Dubrovnik: fewer tourists, lower prices and pleasant temperature (20-24°C). The festival includes gala dinners, producers' markets and cooking classes." }
      },
      {
        name: { es: "Festival de Invierno de Dubrovnik", en: "Dubrovnik Winter Festival" },
        date: { es: "Diciembre", en: "December" },
        type: "cultural",
        description: { es: "Mercado navideño en el Stradun con puestos de artesanía, vino caliente y dulces croatas. La ciudad vacía de turistas de verano tiene otra dimensión en diciembre: los lugareños vuelven al Stradun, los precios de los hoteles caen un 60-70% y las murallas se pueden recorrer prácticamente en soledad. Es el secreto mejor guardado de Dubrovnik.", en: "Christmas market on the Stradun with craft stalls, mulled wine and Croatian sweets. The city emptied of summer tourists takes on a different dimension in December: locals return to the Stradun, hotel prices drop 60-70% and the walls can be walked in near solitude. It's Dubrovnik's best-kept secret." }
      }
    ],
    services: {
      activities: ["getyourguide", "tiqets", "viator"],
...
{{CTA:tickets:tiqets:dubrovnik city walls ticket:Entradas para las murallas de Dubrovnik}}
...
{{CTA:activity:getyourguide:dubrovnik game of thrones walls tour:Tour de Juego de Tronos + murallas}}
...
{{CTA:hotel:booking:dubrovnik hotel may september:Hoteles en Dubrovnik — mejores precios en mayo y septiembre}}
...
{{CTA:service:safetywing:safetywing travel insurance croatia:Seguro de viaje para Croacia}}`,
      en: `I'm going to tell you the truth about Dubrovnik because nobody else does: in July it's a tourist nightmare. Cruise ships unload between 8,000 and 12,000 people a day into a city whose old town covers just 2km². The Stradun — the main street — becomes a river of selfie sticks and people looking at their phones. The price of a terrace beer exceeds €8. And the worst part: you don't see the city. The city is buried under mass tourism.
...
{{CTA:tickets:tiqets:dubrovnik city walls ticket:Dubrovnik city walls tickets}}
...
{{CTA:activity:getyourguide:dubrovnik game of thrones walls tour:Game of Thrones + walls tour}}
...
{{CTA:hotel:booking:dubrovnik hotel may september:Dubrovnik hotels — best prices in May and September}}

For travel insurance, Croatia is in the European Union but SafetyWing covers adventure activities (kayaking, hiking, water sports) better than a standard credit card insurance.

{{CTA:service:safetywing:safetywing travel insurance croatia:Travel insurance for Croatia}}`
    },
    faq: {
      es: [
        { question: "¿Cuándo es el mejor momento para visitar Dubrovnik?", answer: "Mayo y septiembre son los mejores meses: temperatura perfecta (22-28°C), pocos cruceros, precios razonables y las murallas sin aglomeraciones. Octubre también funciona bien y tiene el Good Food Festival. Evita julio y agosto a menos que tengas reservas de hotel hechas con mucha antelación, estés dispuesto a pagar precios premium y aceptes compartir la ciudad con miles de turistas de crucero." },
        { question: "¿Cuánto cuesta visitar Dubrovnik?", answer: "Dubrovnik es cara para estándares croatas. En temporada alta (julio-agosto): alojamiento 150-350€/noche, cena en ciudad vieja 40-70€ para dos, entrada a las murallas 35€. En temporada media (mayo, septiembre): alojamiento 80-150€/noche, cena 25-45€ para dos. Fuera de temporada (noviembre-marzo) los precios se reducen a la mitad y muchos negocios cierran o tienen horarios reducidos." },
        { question: "¿Vale la pena el tour de Juego de Tronos en Dubrovnik?", answer: "Sí, especialmente si has visto la serie. Los guías combinan historia real de la ciudad con las localizaciones del rodaje de forma entretenida e informativa. El Fuerte Lovrijenac (la Fortaleza Roja), el Stradun y las murallas cobran otra dimensión. Los tours duran unas 2 horas y cuestan entre 25-40€. Incluso para quienes no han visto GoT, es una forma original de descubrir la historia medieval de la ciudad." },
        { question: "¿Cómo llegar a Dubrovnik?", answer: "El aeropuerto de Dubrovnik (DBV) tiene vuelos directos desde la mayoría de ciudades europeas en temporada. El autobús de aeropuerto a la ciudad vieja cuesta 5€ y tarda 30-40 minutos. Taxi o transfer: 25-35€. Alternativa por tierra: autobús desde Split (2,5-3 horas, 15-20€) o desde Mostar, Bosnia (3 horas). Los ferris desde Split y las islas de la costa dálmata son una opción escénica en temporada de verano." },
        { question: "¿Hay algo que hacer en Dubrovnik más allá del turismo masivo?", answer: "Sí. Alquila una bicicleta y explora el barrio de Lapad, donde viven los dubrovnikenses reales lejos del centro turístico. Toma el ferry a las islas Elafiti (Šipan, Lopud, Koločep) para playas sin masificación. El mercado de verduras matutino junto a la Puerta Pile tiene queso dálmata, miel y aceite de oliva local a precios razonables. Por la noche, los dubrovnikenses locales van a los bares del barrio de Gruž, no al Stradun." }
      ],
      en: [
        { question: "What is the best time to visit Dubrovnik?", answer: "May and September are the best months: perfect temperature (22-28°C), few cruise ships, reasonable prices and the walls without crowds. October also works well and has the Good Food Festival. Avoid July and August unless you've booked accommodation well in advance, are willing to pay premium prices and accept sharing the city with thousands of cruise tourists." },
        { question: "How much does it cost to visit Dubrovnik?", answer: "Dubrovnik is expensive by Croatian standards. In high season (July-August): accommodation €150-350/night, dinner in old town €40-70 for two, walls entry €35. In mid-season (May, September): accommodation €80-150/night, dinner €25-45 for two. Out of season (November-March) prices halve and many businesses close or have reduced hours." },
        { question: "Is the Game of Thrones tour in Dubrovnik worth it?", answer: "Yes, especially if you've watched the show. The guides combine the city's real history with filming locations in an entertaining and informative way. Lovrijenac Fortress (the Red Keep), the Stradun and the walls take on another dimension. Tours last about 2 hours and cost €25-40. Even for those who haven't watched GoT, it's an original way to discover the city's medieval history." },
        { question: "How do you get to Dubrovnik?", answer: "Dubrovnik Airport (DBV) has direct flights from most European cities in season. The airport bus to the old town costs €5 and takes 30-40 minutes. Taxi or transfer: €25-35. Overland alternative: bus from Split (2.5-3 hours, €15-20) or from Mostar, Bosnia (3 hours). Ferries from Split and the Dalmatian coast islands are a scenic option in summer." },
        { question: "Is there anything to do in Dubrovnik beyond mass tourism?", answer: "Yes. Rent a bike and explore the Lapad neighbourhood where real Dubrovnik residents live away from the tourist centre. Take the ferry to the Elafiti Islands (Šipan, Lopud, Koločep) for uncrowded beaches. The morning vegetable market next to Pile Gate has Dalmatian cheese, honey and local olive oil at reasonable prices. At night, locals go to the bars in the Gruž neighbourhood, not the Stradun." }
      ]
    }
  },
  {
    ...
    pointsOfInterest: [
      {
        name: { es: "El Poblado", en: "El Poblado" },
        description: { es: "El barrio donde aterrizan todos los nómadas digitales, los expats y los viajeros con buena guía. Parque Lleras como epicentro de la vida nocturna, restaurantes de fusión colombo-internacional, hostels premium con piscina en la azotea y el mejor café de Colombia a 1.500 pesos (menos de 0,40€). El Poblado es el más seguro y el más caro del Medellín turístico — pero 'el más caro' aquí significa que un buen restaurante sale a 15-20€ para dos con vino. La trampa del Poblado es que puedes quedarte atrapada aquí cuatro días olvidando que existe el resto de la ciudad. Lo digo por experiencia.", en: "The neighbourhood where all digital nomads, expats and well-guided travellers land. Parque Lleras as the epicentre of nightlife, Colombian-international fusion restaurants, premium hostels with rooftop pools and the best coffee in Colombia at 1,500 pesos (under €0.40). El Poblado is the safest and most expensive of tourist Medellín — but 'most expensive' here means a good restaurant costs €15-20 for two with wine. The Poblado trap is that you can get stuck here for four days forgetting the rest of the city exists. I speak from experience." },
        affiliateLinks: [
          { partner: "booking", label: { es: "Hoteles en El Poblado, Medellín", en: "Hotels in El Poblado, Medellín" }, query: "el poblado medellin hotel" }
        ]
      },
      {
        name: { es: "Metrocable y las Comunas", en: "Metrocable and the Comunas" },
        description: { es: "El sistema de metrocable que Medellín construyó para conectar los barrios más pobres de las laderas con el metro del valle. Una decisión de urbanismo social que transformó comunidades que antes tardaban 90 minutos en bajar al centro en 10 minutos de teleférico. El resultado más visible de esa transformación es la Comuna 13: antes el barrio más peligroso de la ciudad, hoy una galería de arte urbano al aire libre donde vivir. El tour de graffiti por la Comuna 13 es el mejor plan de un día en Medellín —guías del propio barrio, historia real, arte genuino.", en: "The metrocable system that Medellín built to connect the poorest hillside neighbourhoods to the valley metro. A social urban planning decision that transformed communities that previously took 90 minutes to reach the city centre into a 10-minute cable car ride. The most visible result of that transformation is Comuna 13: once the most dangerous neighbourhood in the city, today an open-air urban art gallery to live in. The graffiti tour of Comuna 13 is the best day plan in Medellín — guides from the neighbourhood itself, real history, genuine art." },
        affiliateLinks: [
          { partner: "getyourguide", label: { es: "Tour de graffiti por la Comuna 13", en: "Comuna 13 graffiti tour" }, query: "medellin comuna 13 graffiti tour" },
          { partner: "viator", label: { es: "Tour por las comunas de Medellín", en: "Medellin comunas tour" }, query: "medellin comunas cultural tour" }
        ]
      },
      {
        name: { es: "Plaza Botero y Centro Cultural", en: "Plaza Botero and Cultural Centre" },
        description: { es: "23 esculturas monumentales de Fernando Botero —el artista colombiano más conocido internacionalmente— instaladas en la plaza frente al Museo de Antioquia. Los cuerpos exageradamente voluminosos de la escultura de Botero son tan reconocibles como controvertidos: el propio artista insiste en que no son gordos, sino llenos. El Museo de Antioquia alberga la colección permanente más grande de Botero en el mundo (donada por él mismo) y vale la entrada. El Centro está en plena transformación: la recuperación urbana del centro histórico de Medellín es uno de los proyectos más ambiciosos de Colombia.", en: "23 monumental sculptures by Fernando Botero — the most internationally recognised Colombian artist — installed in the square in front of the Museum of Antioquia. The exaggeratedly voluminous bodies of Botero's sculpture are as recognisable as they are controversial: the artist himself insists they are not fat, but full. The Museum of Antioquia houses the world's largest permanent Botero collection (donated by the artist himself) and is worth the entry. The Centre is in full transformation: the urban recovery of Medellín's historic centre is one of Colombia's most ambitious projects." },
        affiliateLinks: [
          { partner: "getyourguide", label: { es: "Tour cultural por el centro de Medellín", en: "Medellín cultural centre tour" }, query: "medellin city center cultural tour" }
        ]
      },
      {
        name: { es: "Jardín Botánico y Parque Explora", en: "Botanical Garden and Parque Explora" },
        description: { es: "Un oasis verde en el corazón del centro de la ciudad. El Jardín Botánico tiene la mayor colección de orquídeas de Colombia (la flor nacional), mariposas en libertad en un orquideorama de madera y bambú y una laguna tranquila donde los paisanos jubilados juegan a las cartas. Adyacente, el Parque Explora es el mayor acuario de agua dulce de Sudamérica — más de 400 especies del río Amazonas y sus afluentes en el corazón de los Andes. El conjunto es de los mejores parques urbanos del continente.", en: "A green oasis in the heart of the city centre. The Botanical Garden has Colombia's largest orchid collection (the national flower), free-roaming butterflies in a wood and bamboo orchidarium and a quiet lagoon where retired locals play cards. Adjacent, Parque Explora is the largest freshwater aquarium in South America — more than 400 species from the Amazon river and its tributaries in the heart of the Andes. Together, it's one of the best urban parks on the continent." },
        affiliateLinks: [
          { partner: "viator", label: { es: "Tour por los barrios verdes de Medellín", en: "Medellin green neighbourhoods tour" }, query: "medellin botanical garden tour" }
        ]
      },
      {
        name: { es: "Guatapé — excursión de un día imprescindible", en: "Guatapé — the essential day trip" },
        description: { es: "A 1h45 de Medellín por carretera, Guatapé es la mejor excursión de día desde cualquier ciudad colombiana. El Peñón de Guatapé —un monolito granítico de 200 metros de altura con 649 escalones tallados en la roca hasta la cima— ofrece vistas a 360° de un embalse artificial con más de 300 islas e islotes. El pueblo de Guatapé tiene las fachadas más coloridas de Colombia y restaurantes de trucha fresca en el lago. Sal antes de las 8am para evitar colas en el Peñón.", en: "1h45 from Medellín by road, Guatapé is the best day trip from any Colombian city. The Peñón de Guatapé — a 200-metre granite monolith with 649 steps carved into the rock to the summit — offers 360° views over an artificial reservoir with more than 300 islands and islets. The town of Guatapé has the most colourful facades in Colombia and fresh trout restaurants on the lake. Leave before 8am to avoid queues at the Peñón." },
        affiliateLinks: [
          { partner: "viator", label: { es: "Excursión a Guatapé desde Medellín", en: "Guatapé day trip from Medellín" }, query: "guatape day trip from medellin" },
          { partner: "getyourguide", label: { es: "Tour a El Peñón y Guatapé", en: "El Peñón and Guatapé tour" }, query: "medellin guatape penon tour" }
        ]
      }
    ],
    events: [
      {
        name: { es: "Feria de las Flores", en: "Flower Festival (Feria de las Flores)" },
        date: { es: "Agosto", en: "August" },
        type: "festival",
        description: { es: "El evento más importante de Medellín. El Desfile de Silleteros es el corazón del festival: campesinos antioqueños bajan desde las laderas cargando silletas — estructuras de flores de hasta 80kg — en una procesión de 3km por las calles del centro. Cada silleta puede tener más de 100 flores distintas. El festival dura diez días con conciertos, exposiciones de orquídeas, corridas de coches clásicos y feria. Agosto es caro y concurrido, pero la Feria de las Flores es de esas experiencias que justifican reservar con seis meses de antelación.", en: "The most important event in Medellín. The Silleteros Parade is the heart of the festival: Antioquian peasants descend from the hillsides carrying silletas — flower structures weighing up to 80kg — in a 3km procession through the city centre streets. Each silleta can have more than 100 different flowers. The festival lasts ten days with concerts, orchid exhibitions, vintage car rallies and a fair. August is expensive and crowded, but the Flower Festival is one of those experiences that justifies booking six months in advance." }
      },
      {
        name: { es: "Festival Internacional de Poesía de Medellín", en: "Medellín International Poetry Festival" },
        date: { es: "Julio", en: "July" },
        type: "art",
        description: { es: "Uno de los festivales de poesía más importantes del mundo hispanohablante, fundado en 1991. Poetas de 40-50 países leen en espacios públicos, plazas, parques y teatros de la ciudad durante una semana. Entrada gratuita a la mayoría de actos. El festival nació como acto de resistencia cultural durante los años más violentos de la ciudad y tiene una historia que lo hace único en el circuito internacional.", en: "One of the most important poetry festivals in the Spanish-speaking world, founded in 1991. Poets from 40-50 countries read in public spaces, squares, parks and theatres across the city for a week. Free entry to most events. The festival was born as an act of cultural resistance during the city's most violent years and has a history that makes it unique on the international circuit." }
      },
      {
        name: { es: "Colombia Moda", en: "Colombia Moda" },
        date: { es: "Julio", en: "July" },
        type: "technology",
        description: { es: "La semana de la moda colombiana, una de las más importantes de América Latina. Medellín es la capital textil de Colombia y Colombia Moda reúne diseñadores locales e internacionales, compradores y prensa en el recinto ferial de Plaza Mayor. Hay eventos públicos además de los profesionales: desfiles, pop-ups y showrooms. La industria textil de Medellín emplea a más de 50.000 personas y tiene una historia de innovación técnica desde los años 1960.", en: "Colombian fashion week, one of the most important in Latin America. Medellín is Colombia's textile capital and Colombia Moda brings together local and international designers, buyers and press at the Plaza Mayor exhibition centre. There are public events alongside the professional programme: runway shows, pop-ups and showrooms. Medellín's textile industry employs more than 50,000 people and has a history of technical innovation since the 1960s." }
      }
    ],
    services: {
      activities: ["getyourguide", "viator"],
    ...
    content: {
      es: `Preparé el itinerario de Medellín durante tres meses. Spreadsheet de zonas por día, lista de restaurantes por barrio con notas de reserva, marcadores de Google Maps con colores por categoría. Llegué a El Poblado, encontré un hostel con terraza y vista a las montañas, pedí un café colombiano de 1.500 pesos y me quedé cuatro días sin salir del barrio.

No me arrepiento.

Medellín es la capital del nomadismo digital en América Latina por razones concretas: coste de vida entre 700 y 1.000€ al mes viviendo decentemente, clima de primavera perpetua (20-27°C, sin estaciones), internet de fibra en todos los co-workings y la mayoría de cafeterías, y una infraestructura de servicios para extranjeros que pocas ciudades del hemisferio sur pueden igualar. Pero la ciudad es también una historia —la más impresionante de transformación urbana del siglo XXI— y esa historia merece entenderse.
...
El tour de graffiti por la Comuna 13 no es turismo de miseria. Es lo contrario: es escuchar a los propios habitantes del barrio contar su historia a través del arte. Las escaleras eléctricas de San Javier conectan los sectores altos con el metro en 6 minutos — antes eran 40 minutos de caminata empinada. Los murales que las flanquean documentan el conflicto, la resistencia y la transformación del barrio con una honestidad que ningún museo puede igualar. Los guías del tour son del barrio y eso se nota.

{{CTA:activity:getyourguide:medellin comuna 13 graffiti tour:Tour de graffiti por la Comuna 13}}

**Guatapé: la excursión que cambia los planes**

Tenía planeado visitar Guatapé en el día 3. Lo visité en el día 6 porque los días 3, 4 y 5 me los robó El Poblado. Vale la pena esperar: el Peñón de Guatapé, ese monolito de granito de 200 metros con 649 escalones tallados en la roca, es uno de los paisajes más absurdos y espectaculares de Sudamérica. El embalse con 300 islas a los pies, el pueblo de colores abajo, las montañas verdes hasta el horizonte. Sal antes de las 8am de Medellín para evitar colas.

{{CTA:activity:viator:guatape day trip from medellin:Excursión a Guatapé desde Medellín}}

**La Plaza Botero: mejor de lo que parece en fotos**

Las 23 esculturas monumentales de Fernando Botero en la plaza frente al Museo de Antioquia son más impresionantes en persona que en foto. El volumen, la escala, el contraste con el edificio neoclásico del museo detrás. El interior del Museo de Antioquia —con la mayor colección de Botero del mundo, donada por él mismo— es uno de los mejores museos de arte de América Latina y cuesta menos de 5€. El barrio alrededor del Centro está en plena regeneración urbana, lo que lo hace interesante y ligeramente caótico a partes iguales.

**El Poblado: donde aterrizas y donde te quedas**

El barrio expat de Medellín tiene una concentración de cafeterías de especialidad, restaurantes internacionales, hostels premium y co-workings que resulta antinatural para una ciudad de esta latitud. Pergamino Café tiene el mejor café de especialidad de Colombia según varias guías y es difícil llevarles la contraria. Los co-workings de Selina y Areatodo tienen internet de fibra, escritorios decentes y comunidades de nómadas establecidas. El precio del alquiler en El Poblado es el más alto de la ciudad — un apartamento de un dormitorio está entre 400 y 700€/mes.

{{CTA:hotel:booking:el poblado medellin hotel:Hoteles en El Poblado, Medellín}}

**Conectividad y presupuesto nómada**

La eSIM de Airalo para Colombia — plan de 3GB por unos 6€ — funciona desde el aterrizaje en el Aeropuerto José María Córdova. La cobertura 4G de Claro y Movistar es sólida en Medellín, Guatapé y el eje cafetero.

{{CTA:service:airalo:airalo colombia esim:eSIM Colombia con Airalo}}

Para el seguro de viaje, SafetyWing cubre Colombia e incluye actividades de aventura. Importante: Colombia tiene actividades de riesgo moderado (senderismo en los Andes, rafting en el Cañón del Cauca) que los seguros de tarjeta de crédito suelen excluir.

{{CTA:service:safetywing:safetywing travel insurance colombia:Seguro de viaje SafetyWing para Colombia}}

Coste de vida real en Medellín para nómada digital: apartamento en El Poblado 400-700€/mes, comida 5-12€/día (entre mercados y restaurantes), co-working 80-150€/mes. Total: 700-1.000€/mes viviendo con criterio. Para eso: ciudad con 2,5 millones de habitantes, cultura gastronómica rica, clima perfecto y una historia de transformación que no para de sorprender.`,
      en: `I prepared the Medellín itinerary for three months. Spreadsheet of areas by day, restaurant list by neighbourhood with booking notes, Google Maps markers with colours by category. I arrived in El Poblado, found a hostel with a terrace and mountain views, ordered a Colombian coffee for 1,500 pesos and spent four days without leaving the neighbourhood.
...
{{CTA:activity:getyourguide:medellin comuna 13 graffiti tour:Comuna 13 graffiti tour}}
...
{{CTA:activity:viator:guatape day trip from medellin:Guatapé day trip from Medellín}}
...
{{CTA:hotel:booking:el poblado medellin hotel:Hotels in El Poblado, Medellín}}
...
{{CTA:service:airalo:airalo colombia esim:Colombia eSIM with Airalo}}
...
{{CTA:service:safetywing:safetywing travel insurance colombia:SafetyWing travel insurance for Colombia}}
...
Real cost of living in Medellín for a digital nomad: apartment in El Poblado €400-700/month, food €5-12/day (between markets and restaurants), co-working €80-150/month. Total: €700-1,000/month living with standards. For that: a city of 2.5 million, rich food culture, perfect climate and a transformation story that keeps on surprising.`
    ...
    faq: {
      ...
      en: [
        ...
        { question: "How do I do the Guatapé day trip from Medellín?", answer: "Options: organised tour (the most comfortable, includes transport, guide and Peñón entry, €30-50), public bus from Terminal del Norte (departures from 6am, 1h45-2h, ticket €5-7 one way), or car hire (not recommended for a first visit). The Peñón has 649 steps — go up before 10am to avoid queues and midday heat. The town of Guatapé is as beautiful as the Peñón and deserves 1-2 hours of exploration." }
      ]
    }
  },
  {
...
{{CTA:insurance:safetywing:southeast asia travel insurance:Get travel insurance for Southeast Asia}}`
  ...
  // ─────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      en: ["Ho Chi Minh", "Saigon", "Vietnam", "Vietnamese food", "Cu Chi tunnels", "banh mi", "what to eat in Vietnam"],
    },
    pointsOfInterest: [
      {
        name: "Mercado Ben Thanh",
        type: "Mercado",
        lat: 10.7725, lng: 106.6981,
        description: {
        ...
        rating: 4.4, priceRange: "Gratis",
        affiliateLinks: [
          { label: { es: "Tour de comida callejera en Saigón", en: "Saigon street food tour" }, partner: "viator", query: "ho chi minh street food tour", type: "activity" },
        ],
      },
      {
        name: "Túneles de Cu Chi",
        type: "Monumento histórico",
        lat: 11.1422, lng: 106.4622,
        description: {
        ...
        rating: 4.7, priceRange: "€5–15",
        affiliateLinks: [
          { label: { es: "Tour guiado túneles de Cu Chi", en: "Guided Cu Chi tunnels tour" }, partner: "getyourguide", query: "cu chi tunnels tour ho chi minh", type: "activity" },
          { label: { es: "Tour Cu Chi + Mekong", en: "Cu Chi + Mekong tour" }, partner: "viator", query: "cu chi tunnels mekong delta", type: "activity" },
        ],
      },
      {
        name: "Museo de los Vestigios de la Guerra",
        type: "Museo",
        lat: 10.7792, lng: 106.6926,
        description: {
      ...
      },
      {
        ...
        rating: 4.6, priceRange: "Gratis",
        affiliateLinks: [
          { label: { es: "Tour histórico de Saigón", en: "Historic Saigon walking tour" }, partner: "civitatis", query: "saigon historical walking tour", type: "activity" },
        ],
      },
      {
        name: "Calle Bui Vien y comida nocturna",
        type: "Barrio",
        lat: 10.7679, lng: 106.6930,
        description: {
        ...
        rating: 4.3, priceRange: "€1–5",
        affiliateLinks: [
          { label: { es: "Tour nocturno gastronómico", en: "Night street food tour" }, partner: "viator", query: "ho chi minh night food tour bui vien", type: "activity" },
        ],
      },
    ],
    events: [
      {
        name: { es: "Tết Nguyên Đán — Año Nuevo Lunar", en: "Tết Nguyên Đán — Lunar New Year" },
        type: "cultural",
        month: { es: "Enero/Febrero", en: "January/February" },
        description: {
      ...
      {
        name: { es: "Ho Chi Minh City Marathon", en: "Ho Chi Minh City Marathon" },
        type: "sport",
      ...
      {
        name: { es: "Festival de la Ciudad (30 de Abril)", en: "City Liberation Festival (April 30)" },
        type: "cultural",
...
El bánh mì: el mejor que comí lo encontré el tercer día, a las 7:30 de la mañana, siguiendo a una mujer con uniforme de enfermera que salía del Hospital Chợ Rẫy. Se paró en un carrito en la acera, pidió sin mirar el cartel (señal inequívoca de cliente habitual), y yo pedí lo mismo con el dedo. Pan recién hecho, paté de hígado, jamón vietnamita, zanahoria encurtida, cilantro, guindilla fresca. Costó 25.000 dong — algo menos de un euro. {{CTA:activity:viator:ho chi minh street food tour:Únete a un tour de comida callejera nocturna}}

Para el Mekong, considera hacer el día completo. {{CTA:activity:civitatis:mekong delta day trip ho chi minh:Tour de día completo al Delta del Mekong}} — los canales, el mercado flotante de Can Tho y el almuerzo de pescado en una casa sobre pilotes. La diferencia entre ir con una agencia local en barca de madera (la versión correcta) y la excursión en autobús turístico es enorme.

Alójate en el Distrito 1, cerca de la calle Dong Khoi. {{CTA:hotel:booking:ho chi minh district 1 hotel:Compara hoteles en el Distrito 1}} — tienes todo a pie: el museo, el barrio colonial, los mejores cafés de especialidad (Vietnam tiene una cultura cafetera extraordinaria — el cà phê trứng, café con yema de huevo batida, es de otro mundo) y acceso fácil a los demás distritos en moto de alquiler o Grab.

Dos notas prácticas: la eSIM {{CTA:service:airalo:airalo esim vietnam:Activa tu eSIM para Vietnam}} es imprescindible — Grab (el Uber local) funciona con datos y es la única forma sensata de moverse sin que te cobren tarifa turística en el taxímetro. Y para el Sudeste Asiático en general, {{CTA:service:safetywing:safetywing nomad insurance:SafetyWing como seguro de viaje}} cubre hasta 90 días y es la opción más sensata para quien viaja más de dos semanas por la región.
...
The bánh mì: the best one I ate I found on day three, at 7:30am, following a woman in a nurse's uniform leaving Chợ Rẫy Hospital. She stopped at a street cart on the pavement, ordered without looking at the board (unmistakable sign of a regular), and I ordered the same thing by pointing. Freshly baked bread, liver pâté, Vietnamese ham, pickled carrot, coriander, fresh chilli. It cost 25,000 dong — just under a euro. {{CTA:activity:viator:ho chi minh street food tour:Join a night street food tour}}

For the Mekong, consider doing the full day. {{CTA:activity:civitatis:mekong delta day trip ho chi minh:Full-day Mekong Delta tour}} — the canals, the floating market at Can Tho and lunch of fresh fish in a house on stilts. The difference between going with a local agency in a wooden boat (the correct version) and the tourist bus excursion is enormous.

Stay in District 1, near Dong Khoi street. {{CTA:hotel:booking:ho chi minh district 1 hotel:Compare hotels in District 1}} — you have everything on foot: the museum, the colonial quarter, the best specialty cafés (Vietnam has an extraordinary coffee culture — cà phê trứng, coffee with whipped egg yolk, is from another world) and easy access to other districts by rental motorbike or Grab.

Two practical notes: the eSIM {{CTA:service:airalo:airalo esim vietnam:Activate your Vietnam eSIM}} is essential — Grab (the local Uber) runs on data and is the only sensible way to get around without being charged tourist rates on the taximeter. And for Southeast Asia generally, {{CTA:service:safetywing:safetywing nomad insurance:SafetyWing as travel insurance}} covers up to 90 days and is the most sensible option for anyone travelling more than two weeks in the region.
...
One last thing about the north-south difference: in Hanoi, phở is eaten in silence, quickly, with little garnish. In Ho Chi Minh, the same soup arrives with an entire plate of fresh herbs — Vietnamese mint, Thai basil, bean sprouts, fresh chilli — and the idea is to keep adding as you eat. It's the same soup and it tastes nothing like the other one.`,
    ...
    faq: {
      es: [
        { question: "¿Cuántos días necesito para Ho Chi Minh?", answer: "Tres días completos son el mínimo razonable: un día para el centro (museo, barrio colonial, Ben Thanh por la mañana y Bui Vien por la noche), un día para Cu Chi, y un día para el Delta del Mekong. Con cinco días puedes añadir el Barrio Chino de Chợ Lớn y las bodegas de café del Distrito 3." },
        { question: "¿Es seguro Ho Chi Minh para el viajero solitario?", answer: "Muy seguro para los estándares del Sudeste Asiático. El riesgo principal es la cartera en motos — lleva la bolsa cruzada al lado interior de la acera. Los robos en restaurantes y mercados son prácticamente inexistentes. Las mujeres viajando solas tienen una experiencia igual de segura que los hombres." },
        { question: "¿Cuánto cuesta comer en Ho Chi Minh?", answer: "La comida callejera y los restaurantes locales cuestan entre 1€ y 4€ por plato. Un pho en restaurante local: 1,50–2€. Un bánh mì: 0,80–1,20€. Una cerveza Tiger en bar de barrio: 0,40–0,60€. En restaurantes para turistas del Distrito 1 los precios son tres o cuatro veces más altos pero siguen siendo baratos respecto a Europa." },
        { question: "¿Qué diferencia hay entre la cocina del norte y del sur de Vietnam?", answer: "La cocina del norte (Hanói) es más sobria, más salada y usa menos hierbas frescas — el phở es el plato central y se come con poca guarnición. La cocina del sur (Ho Chi Minh) usa más azúcar de coco, más hierbas frescas, más leche de coco en los currys y las sopas llegan con un plato entero de guarnición para añadir. El bún bò Huế (del centro) combina las dos tradiciones y es la sopa más compleja de Vietnam." },
        { question: "¿Cuál es la mejor forma de moverse por Ho Chi Minh?", answer: "Grab (la versión local de Uber, en moto o en coche) es la opción más práctica y la más honesta en precios — los taxímetros de algunos taxis tienen manipulaciones conocidas. Para las distancias cortas dentro del Distrito 1, a pie. Para Cu Chi y el Mekong, un tour organizado con transporte incluido es la opción más cómoda y no mucho más cara que ir por tu cuenta." },
      ],
      en: [
        { question: "How many days do I need for Ho Chi Minh?", answer: "Three full days is the minimum: one day for the centre (museum, colonial quarter, Ben Thanh in the morning, Bui Vien at night), one day for Cu Chi, and one day for the Mekong Delta. With five days you can add the Chợ Lớn Chinatown and the coffee warehouses of District 3." },
        { question: "Is Ho Chi Minh safe for solo travellers?", answer: "Very safe by Southeast Asian standards. The main risk is your wallet on motorbikes — carry your bag crossed on the inner side of the pavement. Theft in restaurants and markets is practically non-existent. Women travelling alone have an equally safe experience to men." },
        { question: "How much does eating in Ho Chi Minh cost?", answer: "Street food and local restaurants cost between €1 and €4 per dish. A phở at a local restaurant: €1.50–2. A bánh mì: €0.80–1.20. A Tiger beer at a neighbourhood bar: €0.40–0.60. At tourist restaurants in District 1, prices are three or four times higher but still cheap by European standards." },
        { question: "What is the difference between northern and southern Vietnamese food?", answer: "Northern cooking (Hanoi) is more austere, saltier and uses fewer fresh herbs — phở is the central dish and is eaten with little garnish. Southern cooking (Ho Chi Minh) uses more coconut sugar, more fresh herbs, more coconut milk in curries, and soups arrive with a whole plate of garnish to add yourself. Bún bò Huế (from the central city) combines both traditions and is Vietnam's most complex soup." },
        { question: "What is the best way to get around Ho Chi Minh?", answer: "Grab (the local version of Uber, by motorbike or car) is the most practical option and the most honest on price — some taxi meters have known manipulation issues. For short distances within District 1, walking. For Cu Chi and the Mekong, an organised tour with transport included is the most comfortable option and not much more expensive than going independently." },
      ],
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      en: ["Porto", "Oporto", "Portugal", "port wine", "Livraria Lello", "Ribeira", "Francesinha", "what to see in Porto"],
    },
    pointsOfInterest: [
      {
        name: "Ribeira y el Duero",
        type: "Barrio histórico",
        lat: 41.1408, lng: -8.6140,
        description: {
        ...
        rating: 4.9, priceRange: "Gratis",
        affiliateLinks: [
          { label: { es: "Tour a pie por la Ribeira", en: "Ribeira walking tour" }, partner: "musement", query: "porto ribeira walking tour", type: "activity" },
        ],
      },
      {
        name: "Livraria Lello",
        type: "Librería histórica",
        lat: 41.1470, lng: -8.6150,
        description: {
        ...
        rating: 4.6, priceRange: "€5",
        affiliateLinks: [
          { label: { es: "Entrada Livraria Lello", en: "Livraria Lello ticket" }, partner: "tiqets", query: "livraria lello porto ticket", type: "tickets" },
        ],
      },
      {
        name: "Bodegas de Vila Nova de Gaia",
        type: "Bodegas",
        lat: 41.1374, lng: -8.6137,
        description: {
        ...
        rating: 4.8, priceRange: "€12–20",
        affiliateLinks: [
          { label: { es: "Tour de bodegas con degustación", en: "Port wine cellars tour with tasting" }, partner: "getyourguide", query: "porto port wine cellars tour tasting", type: "activity" },
        ],
      },
      {
        name: "Iglesia de São Francisco y las Catacumbas",
        type: "Iglesia histórica",
        lat: 41.1415, lng: -8.6165,
        description: {
      ...
      },
      {
        ...
        rating: 4.6, priceRange: "€15–25",
        affiliateLinks: [],
      },
    ],
    events: [
      {
        name: { es: "São João do Porto (23-24 de Junio)", en: "São João do Porto (June 23-24)" },
        type: "festival",
        month: { es: "Junio", en: "June" },
        description: {
      ...
      {
        name: { es: "Festa da Francesinha", en: "Francesinha Festival" },
        type: "gastronomy",
      ...
      {
        name: { es: "Porto/Post/Doc Film Festival", en: "Porto/Post/Doc Film Festival" },
        type: "art",
    ...
    services: {
      activities: ["getyourguide", "tiqets", "musement"],
      hotels: ["booking"],
      transport: ["trainline"],
      insurance: ["safetywing"],
      esim: ["airalo"],
...
{{CTA:activity:musement:porto ribeira walking tour:Tour a pie por la Ribeira y el centro histórico}} — con guía que explique la arquitectura de los azulejos (cada patrón tiene un significado, no es decoración aleatoria) y la relación histórica con los ingleses que controlaron el comercio del vino durante tres siglos.

Para ir de Lisboa, el tren es la opción correcta. {{CTA:service:airalo:airalo esim portugal:eSIM para Portugal}} necesaria si vas a moverte entre ciudades — la cobertura en la línea Lisboa-Porto es perfecta. El trayecto dura 2h45min a 3h en el Alfa Pendular, cuesta entre 20€ y 35€ con anticipación y el paisaje del Valle del Duero en la segunda mitad es la mejor publicidad involuntaria para el turismo de viñedos.

Alójate en la Baixa o en la Ribeira. {{CTA:hotel:booking:oporto hotel ribeira baixa:Compara hoteles en Oporto}} — el acceso a pie a todo el centro histórico justifica pagar un poco más que en los barrios periféricos. Los hostales de la Ribeira son algunos de los mejores de Portugal: edificios del siglo XVIII restaurados, vistas al Duero, desayunos de pastel de nata y café.

Para el seguro de viaje en Portugal y Europa, {{CTA:service:safetywing:safetywing viaje europa:SafetyWing para viajes por Europa}} — especialmente si el viaje a Oporto es parte de un itinerario más largo por la Península Ibérica.
...
{{CTA:activity:musement:porto ribeira walking tour:Ribeira and historic centre walking tour}} — with a guide who explains the azulejo tile architecture (each pattern has a meaning, it's not random decoration) and the historical relationship with the English who controlled the wine trade for three centuries.

To get from Lisbon, the train is the correct option. {{CTA:service:airalo:airalo esim portugal:eSIM for Portugal}} is necessary if you're moving between cities — coverage on the Lisbon-Porto line is perfect. The journey takes 2h45min to 3h on the Alfa Pendular, costs €20–35 in advance, and the Douro Valley landscape in the second half is the best involuntary advertisement for vineyard tourism.

Stay in the Baixa or the Ribeira. {{CTA:hotel:booking:oporto hotel ribeira baixa:Compare hotels in Porto}} — walking access to all the historic centre justifies paying a little more than in peripheral neighbourhoods. The Ribeira hostels are some of the best in Portugal: 18th-century buildings restored, Douro views, breakfasts of pastel de nata and coffee.

For travel insurance in Portugal and Europe, {{CTA:service:safetywing:safetywing travel europe:SafetyWing for European travel}} — especially if the Porto trip is part of a longer Iberian Peninsula itinerary.
...
One final note: Matosinhos, the fishing neighbourhood 20 minutes by metro, is where Porto residents who work near the sea eat. The fish market has the best seafood in northern Portugal. I arrived without a reservation on a Tuesday at half past one, sat on a terrace beside the dock, ordered grilled octopus and barnacles, and paid €18 for what any tourist restaurant on the Ribeira would have charged double. That is also Porto.`,
    ...
    faq: {
      es: [
        { question: "¿Cuántos días necesito para visitar Oporto?", answer: "Con tres días tienes lo suficiente para ver lo esencial: la Ribeira, las bodegas de Vila Nova de Gaia, la Livraria Lello, la Iglesia de São Francisco y una excursión a Matosinhos. Con cinco días puedes añadir una excursión al Valle del Duero (las viñas en terraza son uno de los paisajes más hermosos de Europa) y explorar los barrios de Bonfim y Cedofeita con más calma." },
        { question: "¿Cómo ir de Lisboa a Oporto?", answer: "El tren Alfa Pendular es la opción correcta: 2h45min–3h de trayecto, sale de Lisboa Oriente, llega a Porto Campanhã (con conexión de metro al centro) o Porto São Bento (en el centro histórico). El precio con antelación es de 20–35€ en segunda clase. El autobús es más barato (desde 10€) pero tarda 3h30min. El avión no tiene sentido para esta distancia." },
        { question: "¿Cuál es la mejor época para visitar Oporto?", answer: "Mayo-junio y septiembre-octubre son los meses ideales: temperaturas de 18-24°C, sin lluvias frecuentes, menos turismo que en verano. Junio tiene la fiesta de São João (23-24 de junio), el evento más auténtico del año. Julio y agosto son los meses de mayor turismo y los precios suben notablemente. El invierno (noviembre-febrero) tiene lluvia frecuente pero es la época más barata y el turismo prácticamente desaparece." },
        { question: "¿Qué es la Francesinha y dónde comerla?", answer: "La Francesinha es el sándwich más contundente de Portugal: pan de molde tostado, filete de ternera, salchicha fresca, jamón cocido, queso fundido por encima y una salsa de cerveza y brandy que es casi una sopa. Es el plato icónico de Oporto — no existe en ninguna otra ciudad de Portugal. Los sitios más recomendados: Café Santiago (el más conocido, siempre con cola), Lado B, O Afonso. Precio medio: 10–14€. No es un plato ligero: pide agua y tómatelo con calma." },
        { question: "¿Cómo funciona la visita a la Livraria Lello?", answer: "La Livraria Lello cobra 5€ de entrada (descontable si compras un libro). La entrada se puede comprar en la web oficial o en plataformas como Tiqets. Las colas sin reserva pueden superar las 2 horas en temporada alta. La visita en sí no dura más de 30-45 minutos. El mejor momento es entre semana a primera hora de la mañana: menos gente, mejor luz para las fotografías y la atmósfera más cercana a la de una librería real." },
      ],
      en: [
        { question: "How many days do I need to visit Porto?", answer: "Three days is enough for the essentials: the Ribeira, the Vila Nova de Gaia cellars, Livraria Lello, São Francisco Church and a trip to Matosinhos. With five days you can add a Douro Valley excursion (the terraced vineyards are one of the most beautiful landscapes in Europe) and explore the Bonfim and Cedofeita neighbourhoods at leisure." },
        { question: "How to get from Lisbon to Porto?", answer: "The Alfa Pendular train is the right option: 2h45min–3h journey, departs from Lisboa Oriente, arrives at Porto Campanhã (with metro connection to the centre) or Porto São Bento (in the historic centre). The price with advance booking is €20–35 in second class. The bus is cheaper (from €10) but takes 3h30min. Flying makes no sense for this distance." },
        { question: "When is the best time to visit Porto?", answer: "May-June and September-October are the ideal months: temperatures of 18-24°C, no frequent rain, less tourism than summer. June has the São João festival (June 23-24), the most authentic event of the year. July and August are peak tourist months and prices rise noticeably. Winter (November-February) has frequent rain but is the cheapest period and tourism practically disappears." },
        { question: "What is the Francesinha and where to eat it?", answer: "The Francesinha is Portugal's most substantial sandwich: toasted white bread, beef steak, fresh sausage, cooked ham, melted cheese on top and a beer and brandy sauce that is almost a soup. It is Porto's iconic dish — it doesn't exist in any other Portuguese city. Most recommended spots: Café Santiago (the best known, always with a queue), Lado B, O Afonso. Average price: €10–14. It is not a light dish: order water and take your time." },
        { question: "How does visiting Livraria Lello work?", answer: "Livraria Lello charges €5 entry (deductible if you buy a book). Tickets can be bought on the official website or platforms like Tiqets. Queues without a reservation can exceed 2 hours in peak season. The visit itself takes no more than 30-45 minutes. The best time is on a weekday at first opening: fewer people, better light for photographs and the atmosphere closest to an actual bookshop." },
      ],
    },
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    keywords: {
      ...
      en: ["Cairo", "Egypt", "Giza Pyramids", "Egyptian Museum", "Khan el-Khalili", "what to see in Cairo", "Egypt travel"],
    },
    pointsOfInterest: [
      {
        ...
        rating: 4.9, priceRange: "€15–20",
        affiliateLinks: [
          { label: { es: "Tour guiado a las Pirámides", en: "Guided Pyramids tour" }, partner: "getyourguide", query: "giza pyramids guided tour cairo", type: "activity" },
          { label: { es: "Tour El Cairo + Guiza completo", en: "Cairo + Giza full day tour" }, partner: "viator", query: "cairo giza full day tour", type: "activity" },
        ],
      },
      {
        ...
        rating: 4.7, priceRange: "€10–15",
        affiliateLinks: [
          { label: { es: "Entrada al Museo Egipcio", en: "Egyptian Museum ticket" }, partner: "getyourguide", query: "egyptian museum cairo ticket tour", type: "tickets" },
        ],
      },
      {
        name: "Khan el-Khalili",
        type: "Bazar histórico",
        lat: 30.0483, lng: 31.2617,
        description: {
        ...
        rating: 4.6, priceRange: "Gratis",
        affiliateLinks: [
          { label: { es: "Tour por El Cairo islámico y Khan el-Khalili", en: "Islamic Cairo and Khan el-Khalili tour" }, partner: "civitatis", query: "islamic cairo khan el khalili walking tour", type: "activity" },
        ],
      },
      {
        name: "Ciudadela de Saladino y Mezquita de Muhammad Ali",
        type: "Fortaleza y mezquita",
        lat: 30.0288, lng: 31.2599,
        description: {
        ...
        rating: 4.7, priceRange: "€5–8",
        affiliateLinks: [],
      },
      {
        name: "Barrio copto de Fustat (El Cairo Viejo)",
        type: "Barrio histórico",
        lat: 30.0040, lng: 31.2296,
        description: {
        ...
        rating: 4.5, priceRange: "Gratis–€3",
        affiliateLinks: [],
      },
    ],
    events: [
      {
        name: { es: "Ramadán en El Cairo", en: "Ramadan in Cairo" },
        type: "cultural",
        month: { es: "Variable (según calendario lunar)", en: "Variable (lunar calendar)" },
        description: {
      ...
      {
        name: { es: "Festival Internacional de Cine de El Cairo", en: "Cairo International Film Festival" },
        type: "art",
        month: { es: "Noviembre", en: "November" },
        description: {
      ...
      {
        name: { es: "Festival del Sol de Abu Simbel (22 feb. y 22 oct.)", en: "Abu Simbel Sun Festival (Feb 22 & Oct 22)" },
        type: "cultural",
        month: { es: "Febrero y Octubre", en: "February and October" },
        description: {
...
Khan el-Khalili is where the plan surrendered. I entered through the main gate intending to spend 45 minutes and leave. Four hours later I was sitting in the El Fishawi café — open continuously since 1773, with copper tables and antique mirrors on the walls — drinking mint tea with the man who has the spice stall by the side entrance. He had explained the difference between Egyptian and Indian turmeric, taught me how to smell quality oud, and told me that 80% of the papyrus sold in the bazaar are modern copies printed with industrial ink. {{CTA:activity:civitatis:islamic cairo khan el khalili walking tour:Islamic Cairo and Khan el-Khalili tour}} — with a guide who knows the difference between the Mamluk and Ottoman-era neighbourhoods.

{{CTA:activity:viator:cairo giza full day tour:Cairo + Giza full day tour}} if you want to combine the pyramids with the museum in a single day with transport between them — traffic between Giza and Tahrir can add an hour and a half on a bad day.

Practical notes that no Notion itinerary resolved in advance: cash in dollars or euros is more useful than a card in many places (ATMs charge high fees), heat from April to October exceeds 35°C — plan outdoor activities for the early morning hours — and women should carry a scarf for mosques and Islamic Cairo. {{CTA:service:safetywing:safetywing insurance egypt africa:SafetyWing for Egypt and Africa travel}} — covers medical evacuation, which in Egypt is the most important coverage to have.

For accommodation, Zamalek (the Nile island, quiet and with good restaurants) or Garden City (by the river, walking distance to the Egyptian Museum) are the most comfortable neighbourhoods for a first visit. {{CTA:hotel:booking:cairo zamalek garden city hotel:Compare hotels in Cairo}} — avoid the Tahrir centre for sleeping: tourist logistics are fine but noise and traffic are constant until late night.

The eSIM {{CTA:service:airalo:airalo esim egypt:Activate your Egypt eSIM}} is essential for using Uber (the most reliable alternative to taxis without manipulable meters) and for maps. Coverage in Cairo and Giza is good; outside the main cities it varies.

A dinner cruise on the Nile is the correct cliché. {{CTA:activity:civitatis:nile dinner cruise cairo:Nile dinner cruise in Cairo}} — it is the correct cliché because it works: the city at night from the river, with illuminated minarets and bridges with cars in both directions, gives a perspective on Cairo that cannot be achieved from land. The spice merchant from Khan el-Khalili recommended it to me. He had no incentive to do so.`,
    },
    faq: {
      es: [
        { question: "¿Necesito visado para entrar a Egipto?", answer: "La mayoría de nacionalidades europeas, americanas y australianas pueden obtener el visado electrónico (e-Visa) online antes del viaje en visa2egypt.gov.eg. El coste es de 25 USD aproximadamente y el proceso tarda entre 3 y 5 días hábiles. También se puede obtener visado a la llegada en el aeropuerto de El Cairo (25 USD en efectivo), pero la e-Visa es más cómoda. Verifica siempre los requisitos específicos de tu pasaporte." },
        { question: "¿Cuántos días son suficientes para El Cairo?", answer: "Cuatro días es el mínimo razonable: un día para Guiza (pirámides, esfinge, Museo GEM o Saqqara), un día para el centro (Museo Egipcio del Tahrir, Khan el-Khalili, ciudadela), un día para El Cairo islámico en profundidad (mezquitas, mercados, barrio copto), y un día libre para lo que hayas encontrado por el camino — que en El Cairo siempre es algo. Con siete días puedes añadir una excursión de dos días a Luxor o Asuán." },
        { question: "¿Es seguro viajar a El Cairo como turista?", answer: "El Cairo es seguro para turistas en las zonas habituales: las pirámides, el museo, Khan el-Khalili, Zamalek, Garden City. El acoso de vendedores informales y guías no oficiales en Guiza es intenso pero no peligroso — contratar un guía oficial elimina prácticamente este problema. Las zonas del norte de la ciudad y los barrios periféricos no son destinos turísticos y no es necesario visitarlos. Sigue las recomendaciones de tu Ministerio de Exteriores antes de viajar." },
        { question: "¿Cuál es la mejor época para visitar El Cairo?", answer: "Octubre a abril es la temporada ideal: temperaturas de 15-25°C, sol sin calor extremo y sin lluvias. Diciembre y enero son los meses más frescos y con más turismo europeo. El Ramadán (fecha variable según calendario lunar) ofrece una experiencia cultural única si estás preparado para el cambio de ritmo de la ciudad. De mayo a septiembre, las temperaturas superan los 35-40°C — no es imposible viajar pero requiere planificación para las actividades exteriores." },
        { question: "¿Cómo moverse entre el centro de El Cairo y las Pirámides de Guiza?", answer: "Uber es la opción más transparente en precio y la más cómoda: 20-30 minutos en tráfico fluido, 8-15 USD según la hora. Los taxis de calle funcionan pero requieren negociar el precio antes de subir (sin taxímetro o con taxímetros manipulados). El metro llega hasta Giza pero requiere 30-40 minutos de caminata adicional desde la estación hasta las pirámides en calor extremo. Los tours organizados incluyen transporte y es la opción más cómoda si vas a combinar varios sitios en un día." },
      ],
      en: [
        { question: "Do I need a visa to enter Egypt?", answer: "Most European, American and Australian nationalities can get an e-Visa online before travelling at visa2egypt.gov.eg. The cost is approximately $25 USD and the process takes 3-5 working days. A visa on arrival at Cairo airport is also available ($25 USD cash), but the e-Visa is more convenient. Always verify the specific requirements for your passport." },
        { question: "How many days are enough for Cairo?", answer: "Four days is the minimum: one day for Giza (pyramids, sphinx, GEM Museum or Saqqara), one day for the centre (Tahrir Egyptian Museum, Khan el-Khalili, citadel), one day for Islamic Cairo in depth (mosques, markets, Coptic quarter), and one free day for whatever you've found along the way — which in Cairo is always something. With seven days you can add a two-day excursion to Luxor or Aswan." },
        { question: "Is it safe to travel to Cairo as a tourist?", answer: "Cairo is safe for tourists in the usual areas: the pyramids, the museum, Khan el-Khalili, Zamalek, Garden City. The harassment from informal vendors and unofficial guides at Giza is intense but not dangerous — hiring a licensed guide practically eliminates this problem. The northern parts of the city and peripheral neighbourhoods are not tourist destinations and there is no need to visit them. Follow your Foreign Ministry's travel advice before departing." },
        { question: "When is the best time to visit Cairo?", answer: "October to April is the ideal season: temperatures of 15-25°C, sun without extreme heat and no rain. December and January are the coolest months and have the most European tourism. Ramadan (variable date according to the lunar calendar) offers a unique cultural experience if you're prepared for the change in the city's rhythm. From May to September, temperatures exceed 35-40°C — travelling is not impossible but requires planning for outdoor activities." },
        { question: "How do you get between central Cairo and the Giza Pyramids?", answer: "Uber is the most transparent in price and most comfortable: 20-30 minutes in flowing traffic, $8-15 USD depending on the time. Street taxis work but require negotiating the price before getting in (no meter or with manipulated meters). The metro reaches Giza but requires 30-40 minutes of additional walking from the station to the pyramids in extreme heat. Organised tours include transport and are the most comfortable option if you're combining several sites in one day." },
      ],
    },
  },
];
