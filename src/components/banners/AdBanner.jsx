...
const PARTNER_BANNERS = {
  ...
  localrent: {
    bg: "linear-gradient(135deg, #0d2a1a 0%, #1a5230 100%)",
    accent: "#44cc88",
    emoji: "🚙",
    tagline: { es: "Coches de empresas locales, precios sin intermediarios", en: "Cars from local companies, no middleman prices" },
    sub: { es: "Seguro incluido · Reserva en 2 minutos · Sin comisiones ocultas", en: "Insurance included · Book in 2 minutes · No hidden fees" },
    offer: { es: "Cancelación gratuita", en: "Free cancellation" },
    cta: { es: "Ver coches locales", en: "Browse local cars" },
    partner: "localrent", query: "", type: "service",
  },
  intui: {
    bg: "linear-gradient(135deg, #1a1205 0%, #3a2a0a 100%)",
    accent: "#e8b84b",
    emoji: "🚐",
    tagline: { es: "Transfers privados sin esperas ni sorpresas", en: "Private transfers with no waiting and no surprises" },
    sub: { es: "Aeropuerto, hotel o estación · Conductor con letrero · Precio fijo", en: "Airport, hotel or station · Driver with sign · Fixed price" },
    offer: { es: "Sin cargos extra", en: "No extra charges" },
    cta: { es: "Reservar transfer", en: "Book transfer" },
    partner: "intui", query: "", type: "service",
  },
  saily: {
    bg: "linear-gradient(135deg, #0a1a2e 0%, #0f2d4a 100%)",
    accent: "#38b6ff",
    emoji: "📡",
    tagline: { es: "eSIM en 150+ países, actívala en segundos", en: "eSIM in 150+ countries, activate in seconds" },
    sub: { es: "By Nord Security · Planes desde 1,99 € · Sin SIM física · Sin roaming", en: "By Nord Security · Plans from €1.99 · No physical SIM · No roaming" },
    offer: { es: "10% descuento primer plan", en: "10% off your first plan" },
    cta: { es: "Ver planes Saily", en: "View Saily plans" },
    partner: "saily", query: "", type: "service",
  },
  nordvpn: {
    bg: "linear-gradient(135deg, #0d0d2e 0%, #1a1a5e 100%)",
    accent: "#5577ff",
    emoji: "🔒",
    tagline: { es: "Navega seguro y accede a contenido de casa", en: "Stay secure and access content from home" },
    sub: { es: "6.300+ servidores · 111 países · Ideal para viajeros frecuentes", en: "6,300+ servers · 111 countries · Perfect for frequent travellers" },
    offer: { es: "Hasta 72% de descuento", en: "Up to 72% off" },
    cta: { es: "Proteger mi conexión", en: "Protect my connection" },
    partner: "nordvpn", query: "", type: "service",
  },
};
